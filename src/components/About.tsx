          ...
          <div className="md:col-span-2">
            <div className="space-y-4 text-slate">
              <div className="flex items-center gap-2 mb-4">
                ...
                <h3 className="text-slate-light font-mono text-lg">
                  Software Engineer
                </h3>
              </div>
              ...
              <p>
                I've delivered SaaS platforms in production environments and
                collaborated with remote teams to launch features that reduced
                processing time by 90% and onboarding costs by 30%. My expertise
                includes developer tooling, event-driven architecture, and
                system design.
              </p>
              ...
              <p>
                ...
                where I architect vacation rental property management systems
                with multi-channel integrations, supporting 1M+ monthly
              ...
              <p>
                ...
                , a loyalty SaaS platform used by 25+ restaurants and 1,000+
                users, where I built the backend with 99.8% uptime and optimized
                infrastructure to cut AWS costs by 25%.
              </p>
