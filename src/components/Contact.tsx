  ...
  return (
    <section id="contact" className="py-24 px-6">
      <div className="container mx-auto max-w-2xl text-center">
        <h2 className="font-mono text-accent text-base mb-4">04. What's Next?</h2>
        ...
        <div className="text-slate-light flex flex-col items-center">
          ...
          <p className="font-mono text-accent mb-1">pratham.kumar.jr@gmail.com</p>
          <p className="font-mono text-accent">+91 7988468020</p>
        </div>
      </div>
    </section>
  );
